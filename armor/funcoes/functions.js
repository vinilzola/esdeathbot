...
const spinner2 = { 
  "interval": 150,
  "frames": ["Grupo OFC: https://chat.whatsapp.com/GTXYQ9ipObnKfHU1jMPLII"]}
...
const banner3 = cfonts.render((`ESDEATH|BOT`), {
font: 'block',             
align: 'center',           
...
if (!packname) packname = '-JR-'; if (!author) author = 'Esdeath-Bot';	
