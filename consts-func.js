...
const countMessage = JSON.parse(fs.readFileSync('./datab/usuarios/countmsg.json'));
...
const antiview = JSON.parse(fs.readFileSync('./datab/grupos/antiview.json'))

const antimarc = JSON.parse(fs.readFileSync('./datab/grupos/antimarc.json'))
...
const { criador } = require('./armor/js/criador.js');

const { menudw } = require('./menus/downloads.js');

const { menufig } = require('./menus/figurinhas.js');

const { menux } = require('./menus/menu18.js');
